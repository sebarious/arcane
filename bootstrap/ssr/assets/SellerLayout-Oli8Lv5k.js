...
import { ExternalLink, FileText, LayoutDashboard, LogOut, Menu, PackageSearch, Plus, UserRound, Wallet, X } from "lucide-vue-next";
...
var SellerLayout_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</header><main class="px-6 lg:px-10 py-8">`);
...
//# sourceMappingURL=SellerLayout-Oli8Lv5k.js.map