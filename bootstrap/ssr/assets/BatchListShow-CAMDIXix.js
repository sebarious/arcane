...
import { computed, createVNode, defineComponent, ref, toDisplayString, unref, useSSRContext, withCtx } from "vue";
...
var BatchListShow_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		const ogDescription = `${props.batch.pack_count} packs live at ${props.store.name} — ${odds.mythic ?? 0} mythic, ${odds.legendary ?? 0} legendary hits still in the pool. See the full card list and pull odds before you buy.`;
		const ogImage = computed(() => {
			...
			return usePage().props.defaultOgImage;
		});
		const bandOrder = [
			{
				key: "mythic",
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(Head), null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<title${_scopeId}>${ssrInterpolate(ogTitle)}</title><meta property="og:title"${ssrRenderAttr("content", ogTitle)}${_scopeId}><meta property="og:description"${ssrRenderAttr("content", ogDescription)}${_scopeId}><meta property="og:image"${ssrRenderAttr("content", ogImage.value)}${_scopeId}><meta property="og:type" content="website"${_scopeId}><meta name="twitter:card" content="summary_large_image"${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", ogTitle)}${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", ogDescription)}${_scopeId}><meta name="twitter:image"${ssrRenderAttr("content", ogImage.value)}${_scopeId}>`);
					else return [
						createVNode("title", null, toDisplayString(ogTitle)),
						createVNode("meta", {
							property: "og:title",
							content: ogTitle
						}),
...
//# sourceMappingURL=BatchListShow-CAMDIXix.js.map