...
//#region resources/ts/Pages/SellerApplications/ThankYou.vue?vue&type=script&setup=true&lang.ts
var ThankYou_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push(ssrRenderComponent(unref(Head), { title: "Partner Application Received" }, null, _parent));
...
//#endregion
//#region resources/ts/Pages/SellerApplications/ThankYou.vue
...
ThankYou_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/ts/Pages/SellerApplications/ThankYou.vue");
...
//# sourceMappingURL=ThankYou-BBLnHmj9.js.map