	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</h2><p class="text-base leading-relaxed text-white/80"> Built to Grow With You. Arcane offers three transparent pricing tiers designed to suit all sellers and buyers. </p></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6"><div class="price-card rounded-xl p-6 flex flex-col gap-4" style="${ssrRenderStyle({
				"--glow": "rgba(163,163,163,0.65)",
				"--shimmer": "rgba(163,163,163,0.1)"
			})}"><div class="price-icon w-12 h-12 rounded-xl flex items-center justify-center"><span class="price-dot w-4 h-4 rounded-full"></span></div><div><div class="price-name text-sm font-bold uppercase tracking-wider mb-1">Common</div><div class="text-2xl font-black text-white">£1–£6</div></div></div><div class="price-card rounded-xl p-6 flex flex-col gap-4" style="${ssrRenderStyle({
				"--glow": "rgba(59,130,246,0.75)",
				"--shimmer": "rgba(59,130,246,0.1)"
			})}"><div class="price-icon w-12 h-12 rounded-xl flex items-center justify-center"><span class="price-dot w-4 h-4 rounded-full"></span></div><div><div class="price-name text-sm font-bold uppercase tracking-wider mb-1">Rare</div><div class="text-2xl font-black text-white">£6–£11</div></div></div><div class="price-card rounded-xl p-6 flex flex-col gap-4" style="${ssrRenderStyle({
				"--glow": "rgba(45,212,191,0.75)",
				"--shimmer": "rgba(45,212,191,0.1)"
...
//# sourceMappingURL=Welcome-BKIrO3o4.js.map