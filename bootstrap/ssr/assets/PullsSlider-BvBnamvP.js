	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({
				...
				aspectRatio: "63/88",
				borderRadius: "10px"
			})}"><img${ssrRenderAttr("src", __props.pull.card.image)}${ssrRenderAttr("alt", __props.pull.card.name)} class="w-full h-full object-cover" draggable="false" loading="lazy"></div></div><div class="${ssrRenderClass([__props.active ? "opacity-100" : "opacity-50", "px-3 mt-2 transition-opacity duration-300"])}"><h4 class="text-base text-white leading-snug mb-0.5" style="${ssrRenderStyle({
...
//# sourceMappingURL=PullsSlider-BvBnamvP.js.map