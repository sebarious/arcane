...
//#region resources/ts/Pages/Auth/ForgotPassword.vue?vue&type=script&setup=true&lang.ts
var ForgotPassword_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</p></button></div>`);
			if (success.value) _push(`<div class="text-[11px] text-emerald-400 mt-1"> If the email exists, a password reset link has been sent. </div>`);
			else _push(`<!---->`);
...
//#endregion
//#region resources/ts/Pages/Auth/ForgotPassword.vue
...
ForgotPassword_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/ts/Pages/Auth/ForgotPassword.vue");
...
//# sourceMappingURL=ForgotPassword-B-r2EEpY.js.map