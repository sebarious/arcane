...
`)}")` };
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.store.logo) _push(`<img${ssrRenderAttr("src", __props.store.logo)}${ssrRenderAttr("alt", __props.store.name)} class="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[100px] top-1/2" loading="lazy">`);
			else _push(`<!---->`);
...
//# sourceMappingURL=StoreIndex-DFSo_euA.js.map