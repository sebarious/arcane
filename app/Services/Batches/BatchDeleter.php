    ...
    public function delete(
        ...
        DB::transaction(function () use ($batch, $reallocateInventory, $deleteInvoice) {
            ...
            if ($reallocateInventory) {
                // Reset cards back to in_stock — including picked_at, since the card
                // physically goes back into its lot's box and should count toward
                // future picking-sheet positions again (see PickingSheetGenerator).
